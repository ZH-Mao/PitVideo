...
def train(config, epoch, num_epoch, epoch_iters, base_lr, num_iters,trainloader, optimizer, model, Seg_loss, Seg_loss2,
    ...
    val_F1_presence = total_num_truePresent/(total_num_truePresent+0.5*(total_num_falsePresent+total_num_falseAbsent))*100
    val_F1_absence = total_num_trueAbsent/(total_num_trueAbsent+0.5*(total_num_falsePresent+total_num_falseAbsent))*100
