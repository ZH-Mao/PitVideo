...
def parse_args():
    ...
    #                     type=str)
    parser.add_argument('--cfg',
                        default=r'/home/zhehua/codes/PitVideo-Segment-Landmark/experiments/pituitary/video_hrnet_convlstm_w48_2stage_5loss_makevideo_fold1.yaml',
                        help='experiment configure file name',
                        type=str)
...
def main():
    ...
    output_folder = 'PitImage_makevideo'
