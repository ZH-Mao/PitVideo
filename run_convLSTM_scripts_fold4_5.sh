...
for CONFIG in "video_hrnet_convlstm_w48_2stage_5loss_fold4.yaml" "video_hrnet_convlstm_w48_2stage_5loss_fold5.yaml" 
do
...
# # run the script with "nohup bash run_convLSTM_scripts_fold4_5.sh > run_convLSTM_scripts_fold4_5.log 2>&1 &"