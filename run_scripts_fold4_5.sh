...
for CONFIG in "video_hrnet_mstcn_w48_2stage_5loss_fold5.yaml" 
do
    ...
    nohup python /home/zhehua/codes/PitVideo-Segment-Landmark/PituVideo_train_MSTCN_DICE_L1_Wing_FL_L1_5loss_2stage_v20240910.py --cfg $INDIR/$CONFIG --gpu "1" > $LOGFILE 2>&1 &
...
# # run the script with "nohup bash run_scripts_fold4_5.sh > run_scripts_fold4_5.log 2>&1 &"