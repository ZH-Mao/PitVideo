...
from lib.core.function_consistency_consecutiveIOUbased_painet_test import validate, test
...
def parse_args():
    ...
    #                     type=str)
    parser.add_argument('--cfg',
                        default=r'/home/zhehua/codes/PitVideo-Segment-Landmark/experiments/pituitary/PAINET_TEST_fold2.yaml',
                        help='experiment configure file name',
                        type=str)
...
def main():
    ...
    validate(config, testloader, model, device)
