...
for CONFIG in "video_hrnet_convlstm_w48_2stage_5loss_fold2.yaml" "video_hrnet_convlstm_w48_2stage_5loss_fold3.yaml" 
do
    ...
    nohup python /home/zhehua/codes/PitVideo-Segment-Landmark/PituVideo_train_convLSTM_DICE_L1_Wing_FL_L1_5loss_2stage_v20240913.py --cfg $INDIR/$CONFIG --gpu "1" > $LOGFILE 2>&1 &
...
# # run the script with "nohup bash run_convLSTM_scripts_fold1_2_3.sh > run_convLSTM_scripts_fold1_2_3.log 2>&1 &"