...
from lib.core.function_consistency_consecutiveIOUbased_sstan_test_perframe import test
...
def parse_args():
    ...
    #                     type=str)
    parser.add_argument('--cfg',
                        default=r'/home/zhehua/codes/PitVideo-Segment-Landmark/experiments/pituitary/video_hrnet_ssstan_w48_2stage_fold1.yaml',
                        help='experiment configure file name',
                        type=str)
    parser.add_argument('--model',
                        default= r'/home/zhehua/data/Results/pituitary/video_hrnet_ssstan_w48_2stage_fold1/val_best_model_epo088.pth',
