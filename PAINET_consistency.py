...
from lib.core.function_consistency_consecutiveIOUbased_painet_test import test
...
def parse_args():
    ...
    #                     type=str)
    parser.add_argument('--cfg',
                        default=r'/home/zhehua/codes/PitVideo-Segment-Landmark/experiments/pituitary/PAINET_TEST_fold1.yaml',
                        help='experiment configure file name',
                        type=str)
    parser.add_argument('--model',
                        default= r'/home/zhehua/codes/PAINet/outputs/models/mul/fold0_1.pth',
...
def main():
    ...
    output_folder = 'PAINET_consecutiveIOU_results2'
