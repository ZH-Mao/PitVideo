...
for CONFIG in "video_hrnet_mstcn_w48_2stage_5loss_fold1.yaml" "video_hrnet_mstcn_w48_2stage_5loss_fold2.yaml" "video_hrnet_mstcn_w48_2stage_5loss_fold3.yaml" "video_hrnet_mstcn_w48_2stage_5loss_fold4.yaml" "video_hrnet_mstcn_w48_2stage_5loss_fold5.yaml"
do
    ...
    nohup python /home/zhehua/codes/PitVideo-Segment-Landmark/PituVideo_mstcn_test_consecutive_IOU.py --cfg $INDIR/$CONFIG --gpu "1" > $LOGFILE 2>&1 &
...
# # run the script with "nohup bash test_mstcn_scripts_fold1_2_3_4_5.sh > test_mstcn_scripts_fold1_2_3_4_5.log 2>&1 &"